...
favnote：匹配收藏备注
      ...
      'restoreTasksAutomaticallyHint': '应用启动时自动恢复下载任务',
      'enableTagZHTranslationInComicInfo': '保存中文标签到ComicInfo',
      'enableTagZHTranslationInComicInfoHint': '如果可用，将在ComicInfo.xml中使用翻译后的标签',
